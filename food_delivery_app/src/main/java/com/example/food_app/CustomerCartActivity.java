...
public class CustomerCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(CustomerCartActivity.this,"Choose Pricing Type To View Total", Toast.LENGTH_SHORT).show();
        ...
        cust_geofire.getLocation("Customer", new LocationCallback() {
            ...
            public void onLocationResult(String key, GeoLocation location) {
                if(location!=null){
                    ...
                    home_geofire.getLocation("Home1", new LocationCallback() {
    ...
    public void getItemData(){
        for(int i = 0;i<CustomerMainActivity.cart.size();i++){
            String[] arr = CustomerMainActivity.cart.get(i);
        ...
        ref.child("status").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(status.equals("accepted")){
                    Intent intent = new Intent(CustomerCartActivity.this,CustomerOTPActivity.class);
