...
public class CustomerCartActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_cart3);
        ...
        Toast.makeText(CustomerCartActivity3.this, "Choose Pricing Type To View Total", Toast.LENGTH_SHORT).show();
        ...
        cust_geofire.getLocation("Customer", new LocationCallback() {
            ...
            public void onLocationResult(String key, GeoLocation location) {
                if (location != null) {
                    ...
                    home_geofire.getLocation("Home3", new LocationCallback() {
    ...
    public void getItemData(){
        for(int i = 0;i<CustomerMainActivity3.cart.size();i++){
            String[] arr = CustomerMainActivity3.cart.get(i);
        ...
        ref.child("status").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(status.equals("accepted")){
                    Intent intent = new Intent(CustomerCartActivity3.this,CustomerOTPActivity.class);
